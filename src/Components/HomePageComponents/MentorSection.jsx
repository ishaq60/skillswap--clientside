    ...
    <section className="bg-indigo-900 text-white py-16 px-4 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {mentors.map((mentor) => (
            <div key={mentor.id} className="bg-white text-gray-800 rounded-lg overflow-hidden shadow-lg">
              {/* Mentor Image */}
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm ml-1">{mentor.rating} ({mentor.reviews})</span>
                  </div>
                  <div className="flex items-center text-blue-500">
                    <Users className="w-4 h-4" />
                    <span className="text-sm ml-1">{mentor.students} Students</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="flex justify-center mt-10">
          ...
          <div className="w-12 h-2 rounded-full bg-blue-500 mx-1"></div>
        </div>
      </div>
    </section>
  );
